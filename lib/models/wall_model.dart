...
//
//     final wallModels = wallModelsFromJson(jsonString);

import 'dart:convert';

List<WallModels> wallModelsFromJson(String str) => List<WallModels>.from(json.decode(str).map((x) => WallModels.fromJson(x)));

String wallModelsToJson(List<WallModels> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class WallModels {
    ...
    factory WallModels.fromJson(Map<String, dynamic> json) => WallModels(
        id: json["id"],
        ...
        links: WallModelLinks.fromJson(json["links"]),
...
class WallModelLinks {
    ...
    factory WallModelLinks.fromJson(Map<String, dynamic> json) => WallModelLinks(
        self: json["self"],
        html: json["html"],
...
class TopicSubmissions {
    ...
    factory TopicSubmissions.fromJson(Map<String, dynamic> json) => TopicSubmissions(
        ...
        travel: json["travel"] == null ? null : Architecture.fromJson(json["travel"]),
    );
